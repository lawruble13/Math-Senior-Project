...
saveas(gcf, '../images/paper_simplex_problem','png');
sp = scatter(0,0,30,'red','filled');
saveas(gcf, '../images/paper_simplex_point_inv','png');
sp.XData = 1;
saveas(gcf, '../images/paper_simplex_point_1','png');
sp.XData = 6.5;
saveas(gcf, '../images/paper_simplex_point_2','png');
sp.XData = 5.5;
sp.YData = 2;
saveas(gcf, '../images/paper_simplex_point_3','png');
